...
const baseFont = "'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif";
...
export const InviteNov21GuestEmail = ({ fullName }: InviteNov21EmailProps) => (
  <Html>
    <Head />
      ...
      >
        <Section style={{ ...baseTextStyles, color: '#f6f6f6', fontSize: 16 }}>
          ...
          <Text style={{ marginBottom: 16 }}>
            Thank you, {fullName.split(' ')[0] || fullName}, for confirming your attendance at Nothing
            Too Serious - an evening of music, poetry, film, and conversation curated by tar1k.
          </Text>
          <Text style={{ marginBottom: 16 }}>
            This is a moment suspended between reflection and becoming - a celebration of effort,
            collaboration, and authenticity. Come open, come curious, and come ready to enjoy art for its own sake.
          </Text>
          <Section
            style={{
              borderRadius: 18,
          ...
          <Text style={{ marginBottom: 20 }}>Dress Code: Come comfortable. It's Nothing Too Serious.</Text>
          <Text style={{ marginBottom: 16 }}>We look forward to sharing this space with you.</Text>
          <Text>
            Warmly,
            <br />
            tar1k &amp; Team
    ...
    <Body style={{ backgroundColor: '#050505', padding: '32px 0' }}>
      ...
      >
        <Section style={{ ...baseTextStyles, color: '#f3f3f3' }}>
          ...
          <Text style={{ marginBottom: 24, color: '#bbbbbb' }}>A guest just confirmed. Details below.</Text>
          <Section
            style={{
              padding: 20,
              borderRadius: 14,
          ...
          >
            <Text style={{ margin: '0 0 8px', fontSize: 18, fontWeight: 600 }}>{fullName}</Text>
            <Text style={{ margin: 0 }}>
